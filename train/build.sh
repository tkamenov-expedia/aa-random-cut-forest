...
do_run() {
    ...
    #docker run $(pwd)/local_test/test_dir:/opt/ml -p $HOST_PORT:$GUEST_PORT  -e AWS_ACCESS_KEY_ID -e AWS_SECRET_ACCESS_KEY -e AWS_SESSION_TOKEN  --rm $APP_NAME train
}

do_release() {
    # releasing to docker registry
    echo 'Releasing...'

...
do_run() {
    ...
    docker run   -i  -v $(pwd)/local_test/test_dir:/opt/ml -p $HOST_PORT:$GUEST_PORT  -e AWS_ACCESS_KEY_ID -e AWS_SECRET_ACCESS_KEY -e AWS_SESSION_TOKEN  --rm $APP_NAME  /bin/sh
}
